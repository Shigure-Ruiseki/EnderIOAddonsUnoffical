...
import static loenwind.enderioaddons.render.FaceRenderer.sideAndFacingToSpriteOffset;
...
public class BlockVoidTank extends AbstractMachineBlock<TileVoidTank> implements IAdvancedTooltipProvider {
    ...
    public static final ModObject ModObject_blockVoidTank = EnumHelper
        .addEnum(ModObject.class, "blockVoidTank", new Class<?>[0], new Object[0]);
    public static BlockVoidTank blockVoidTank;
    public int localRenderId;

    public static BlockVoidTank create() {
        PacketHandler.INSTANCE
            .registerMessage(PacketVoidTank.class, PacketVoidTank.class, PacketHandler.nextID(), Side.CLIENT);
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
        if (rand.nextInt(200) == 0) {
            world
                .playSound(x + 0.5D, y + 0.5D, z + 0.5D, "portal.portal", 0.25F, rand.nextFloat() * 0.4F + 0.4F, false);
        }
