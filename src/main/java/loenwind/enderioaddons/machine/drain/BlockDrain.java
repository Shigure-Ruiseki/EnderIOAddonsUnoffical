package loenwind.enderioaddons.machine.drain;
...
public class BlockDrain extends AbstractMachineBlock<TileDrain> implements IAdvancedTooltipProvider {
    ...
    public static final ModObject ModObject_blockDrain = EnumHelper
        .addEnum(ModObject.class, "blockDrain", new Class<?>[0], new Object[0]);
    public static BlockDrain blockDrain;
    public int localRenderId;

    public static BlockDrain create() {
        PacketHandler.INSTANCE
            .registerMessage(PacketDrain.class, PacketDrain.class, PacketHandler.nextID(), Side.CLIENT);
    ...
    public void addCommonEntries(ItemStack itemstack, EntityPlayer entityplayer, List list, boolean flag) {
        if (!Config.drainAllowOnDedicatedServer.getBoolean() && !Minecraft.getMinecraft()
            .isSingleplayer()) {
